...
-- concurrency_style column the up dropped, and restore the
...
-- restore the dropped column's data: the platform is pre-deployment, so no
-- pool carried a value before the drop.
