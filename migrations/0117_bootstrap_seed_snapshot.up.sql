...
-- promote to live at Verification-phase completion (§25.10). The table is platform-scoped (the §25 control plane is
...
-- staleness warning; written_at drives the §25.10 staleness
