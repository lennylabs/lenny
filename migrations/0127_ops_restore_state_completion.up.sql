...
-- completion reconciler polls (job_id, §25.11), and the
...
-- gdpr.backup_reconcile_blocked stall (§25.11, §12.8 phase 2).
...
--
-- ops_restore_state is platform-scoped (§25.4), so no tenant
