...
case "${LENNY_LOAD_SCALE}" in
  small)
    ...
    # Cloud SQL db-custom-1-3840 (1 vCPU, 3.75 GB), Memorystore 1 GB Standard-HA.
    export CLOUD_SQL_TIER="${CLOUD_SQL_TIER:-db-custom-1-3840}"
    export CLOUD_SQL_DISK_SIZE_GB="${CLOUD_SQL_DISK_SIZE_GB:-20}"
    export MEMORYSTORE_TIER="${MEMORYSTORE_TIER:-STANDARD_HA}"
    export MEMORYSTORE_MEMORY_SIZE_GB="${MEMORYSTORE_MEMORY_SIZE_GB:-1}"
    ;;
  medium)
    ...
    # Cloud SQL db-custom-2-7680 (2 vCPU, 7.5 GB), Memorystore 2 GB Standard-HA.
    export CLOUD_SQL_TIER="${CLOUD_SQL_TIER:-db-custom-2-7680}"
    export CLOUD_SQL_DISK_SIZE_GB="${CLOUD_SQL_DISK_SIZE_GB:-50}"
    export MEMORYSTORE_TIER="${MEMORYSTORE_TIER:-STANDARD_HA}"
    export MEMORYSTORE_MEMORY_SIZE_GB="${MEMORYSTORE_MEMORY_SIZE_GB:-2}"
    ;;
  production)
    ...
    # Cloud SQL db-custom-4-15360 (4 vCPU, 15 GB), Memorystore 5 GB Standard-HA.
    export CLOUD_SQL_TIER="${CLOUD_SQL_TIER:-db-custom-4-15360}"
    export CLOUD_SQL_DISK_SIZE_GB="${CLOUD_SQL_DISK_SIZE_GB:-100}"
    export MEMORYSTORE_TIER="${MEMORYSTORE_TIER:-STANDARD_HA}"
    export MEMORYSTORE_MEMORY_SIZE_GB="${MEMORYSTORE_MEMORY_SIZE_GB:-5}"
    ;;
  *)
