...
LENNY_VERSION_GOLANGCI_LINT="2.12.2"   # v2 series; required for Go 1.26+ export-data (v1.x aborts "unsupported version: 2"). Installed via the upstream install script (prebuilt binary)
