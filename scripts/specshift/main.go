...
//
// The domain printed is the pass's site-rewrite domain, which is what the
// count line names it. The measurement is a function of the pass name
// alone, so it does not build the pass, and the key-rewrite channel's
// registers are outside it.
