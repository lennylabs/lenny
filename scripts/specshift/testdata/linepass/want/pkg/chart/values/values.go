...
//
// spec: §4.6
const clusterHelp = "The cluster-type dimension is stated in §4.6."
...
type Values struct {
	...
	//
	// spec: §4.6
	Cluster string `json:"cluster,omitempty" desc:"Cluster-type composition dimension (laptop, eks, or gke)."`
}
