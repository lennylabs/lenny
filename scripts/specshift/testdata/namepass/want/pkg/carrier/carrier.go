...
// Package carrier is an ordinary tracked Go carrier. It documents the CH-PODLIFECYCLE, which is a site the pass writes, and it holds the same phrase in a
...
func Ack() bool {
	// The implementation comment here names the CH-ADAPTEREVENTS. A comment
