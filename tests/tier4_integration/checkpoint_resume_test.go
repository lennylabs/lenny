...
// Tier-4 integration coverage for the §10.1.7 reassembly-on-resume
...
// spec: §10.1.7 — the gateway mints one GET capability per chunk in
...
// spec: §10.1.7 — a partial checkpoint with a non-NULL
