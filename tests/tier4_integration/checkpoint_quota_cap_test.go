...
//
// spec: §11.2 (the quota cap is a gateway observation), §10.1.7
...
// spec: §10.1.7 / §13.2 — a ChunkReady whose declared length
...
func TestCheckpointRejectsOverChunkSizeDeclaration(t *testing.T) {
	...
	// spec: §10.1.7 — the zero-chunk abort soft-deletes the row in the
