...
TESTING.md §12.2.5 + TESTING.md §12.3.3: byte-equivalent round-trips of canonical OpenAI
Responses API request/response pairs. The Responses API has the
extended `id` field behavior documented in TESTING.md §12.3.3; the corpus
