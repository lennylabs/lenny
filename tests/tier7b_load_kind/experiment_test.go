...
// TESTING.md §13.34 phase gate baselines the §10.7 ExperimentRouter hot path —
...
// `minWarm` coupling at the §16.5 release gate. The TESTING.md §13.34 phase gate
...
// does not configure. The experiment_load scenario is the TESTING.md §13.34
...
// diagnosis: the TESTING.md §13.34 experiment_load run has no active experiment
...
// exercise. The experiment_load scenario is the TESTING.md §13.34 substrate the
...
func TestExperimentLoad(t *testing.T) {
	...
	t.Skip("phase-gated: the TESTING.md §13.34 experiment_load run measures the §10.7 " +
		...
		"the baseRuntime, and the variant pools, then runs the strict TESTING.md §13.34 " +
