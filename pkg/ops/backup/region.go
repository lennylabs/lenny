...
// fail-closed condition. spec: §12.8.
...
// that region's shards only. spec: §12.8.
...
// residencyOperationBackup is the §12.8 operation label on the
...
// deterministic (sorted) order, mirroring the §25.11
