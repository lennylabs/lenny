...
// source transition. spec: §25.5; §25.2.
const (
...
// the split is unambiguous. spec: §25.5.
...
// sources, which ignore it. spec: §25.5.
...
// Agents MUST NOT parse the result. spec: §25.5.
...
// degrades to the key-only form. spec: §25.5.
