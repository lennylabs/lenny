...
var file_lenny_adapter_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_lenny_adapter_proto_goTypes = []any{
	...
	(*SetupCommandOutput)(nil),         // 20: lenny.adapter.v1.SetupCommandOutput
	(*StartSessionRequest)(nil),        // 21: lenny.adapter.v1.StartSessionRequest
	(*SetupPolicy)(nil),                // 22: lenny.adapter.v1.SetupPolicy
	(*StartSessionResponse)(nil),       // 23: lenny.adapter.v1.StartSessionResponse
	(*SendMessageRequest)(nil),         // 24: lenny.adapter.v1.SendMessageRequest
	(*SendMessageResponse)(nil),        // 25: lenny.adapter.v1.SendMessageResponse
	(*AttachRequest)(nil),              // 26: lenny.adapter.v1.AttachRequest
	(*AttachResponse)(nil),             // 27: lenny.adapter.v1.AttachResponse
	(*AssignCredentialsRequest)(nil),   // 28: lenny.adapter.v1.AssignCredentialsRequest
	(*AssignCredentialsResponse)(nil),  // 29: lenny.adapter.v1.AssignCredentialsResponse
	(*RotateCredentialsRequest)(nil),   // 30: lenny.adapter.v1.RotateCredentialsRequest
	(*RotateCredentialsResponse)(nil),  // 31: lenny.adapter.v1.RotateCredentialsResponse
	(*RevokeCredentialsRequest)(nil),   // 32: lenny.adapter.v1.RevokeCredentialsRequest
	(*RevokeCredentialsResponse)(nil),  // 33: lenny.adapter.v1.RevokeCredentialsResponse
	(*CredentialLease)(nil),            // 34: lenny.adapter.v1.CredentialLease
	(*InterruptRequest)(nil),           // 35: lenny.adapter.v1.InterruptRequest
	(*InterruptResponse)(nil),          // 36: lenny.adapter.v1.InterruptResponse
	(*CheckpointRequest)(nil),          // 37: lenny.adapter.v1.CheckpointRequest
	(*CheckpointResponse)(nil),         // 38: lenny.adapter.v1.CheckpointResponse
	(*ResumeRequest)(nil),              // 39: lenny.adapter.v1.ResumeRequest
	(*ResumeResponse)(nil),             // 40: lenny.adapter.v1.ResumeResponse
	(*ExportSpec)(nil),                 // 41: lenny.adapter.v1.ExportSpec
	(*ExportPathsRequest)(nil),         // 42: lenny.adapter.v1.ExportPathsRequest
	(*ExportedFile)(nil),               // 43: lenny.adapter.v1.ExportedFile
	(*ExportPathsResponse)(nil),        // 44: lenny.adapter.v1.ExportPathsResponse
	(*ReportUsageRequest)(nil),         // 45: lenny.adapter.v1.ReportUsageRequest
	(*ReportUsageResponse)(nil),        // 46: lenny.adapter.v1.ReportUsageResponse
	(*ExtendLeaseRequest)(nil),         // 47: lenny.adapter.v1.ExtendLeaseRequest
	(*ExtendLeaseResponse)(nil),        // 48: lenny.adapter.v1.ExtendLeaseResponse
	(*ShutdownRequest)(nil),            // 49: lenny.adapter.v1.ShutdownRequest
	(*ShutdownResponse)(nil),           // 50: lenny.adapter.v1.ShutdownResponse
	(*ConfigureWorkspaceRequest)(nil),  // 51: lenny.adapter.v1.ConfigureWorkspaceRequest
	(*ConfigureWorkspaceResponse)(nil), // 52: lenny.adapter.v1.ConfigureWorkspaceResponse
	(*DemoteSDKRequest)(nil),           // 53: lenny.adapter.v1.DemoteSDKRequest
	(*DemoteSDKResponse)(nil),          // 54: lenny.adapter.v1.DemoteSDKResponse
	(*NegotiateVersionRequest)(nil),    // 55: lenny.adapter.v1.NegotiateVersionRequest
	(*NegotiateVersionResponse)(nil),   // 56: lenny.adapter.v1.NegotiateVersionResponse
	(*LifecycleChannelRequest)(nil),    // 57: lenny.adapter.v1.LifecycleChannelRequest
	(*LifecycleChannelResponse)(nil),   // 58: lenny.adapter.v1.LifecycleChannelResponse
	nil,                                // 59: lenny.adapter.v1.StartSessionRequest.LabelsEntry
	nil,                                // 60: lenny.adapter.v1.StartSessionRequest.TracingContextEntry
	nil,                                // 61: lenny.adapter.v1.AssignCredentialsRequest.LeasesEntry
	nil,                                // 62: lenny.adapter.v1.RotateCredentialsRequest.LeasesEntry
	nil,                                // 63: lenny.adapter.v1.ResumeRequest.TracingContextEntry
	nil,                                // 64: lenny.adapter.v1.ConfigureWorkspaceRequest.TracingContextEntry
}
var file_lenny_adapter_proto_depIdxs = []int32{
	...
	22, // 11: lenny.adapter.v1.RunSetupRequest.setup_policy:type_name -> lenny.adapter.v1.SetupPolicy
	20, // 12: lenny.adapter.v1.RunSetupResponse.outputs:type_name -> lenny.adapter.v1.SetupCommandOutput
	6,  // 13: lenny.adapter.v1.StartSessionRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	59, // 14: lenny.adapter.v1.StartSessionRequest.labels:type_name -> lenny.adapter.v1.StartSessionRequest.LabelsEntry
	12, // 15: lenny.adapter.v1.StartSessionRequest.experiment_context:type_name -> lenny.adapter.v1.ExperimentContext
	60, // 16: lenny.adapter.v1.StartSessionRequest.tracing_context:type_name -> lenny.adapter.v1.StartSessionRequest.TracingContextEntry
	6,  // 17: lenny.adapter.v1.SendMessageRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	7,  // 18: lenny.adapter.v1.SendMessageRequest.slot_id:type_name -> lenny.adapter.v1.SlotId
	6,  // 19: lenny.adapter.v1.AttachRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	7,  // 20: lenny.adapter.v1.AttachRequest.slot_id:type_name -> lenny.adapter.v1.SlotId
	6,  // 21: lenny.adapter.v1.AssignCredentialsRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	61, // 22: lenny.adapter.v1.AssignCredentialsRequest.leases:type_name -> lenny.adapter.v1.AssignCredentialsRequest.LeasesEntry
	6,  // 23: lenny.adapter.v1.RotateCredentialsRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	62, // 24: lenny.adapter.v1.RotateCredentialsRequest.leases:type_name -> lenny.adapter.v1.RotateCredentialsRequest.LeasesEntry
	6,  // 25: lenny.adapter.v1.RevokeCredentialsRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	6,  // 26: lenny.adapter.v1.InterruptRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	2,  // 27: lenny.adapter.v1.InterruptRequest.mode:type_name -> lenny.adapter.v1.InterruptRequest.Mode
	3,  // 28: lenny.adapter.v1.InterruptResponse.status:type_name -> lenny.adapter.v1.InterruptResponse.Status
	6,  // 29: lenny.adapter.v1.CheckpointRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	6,  // 30: lenny.adapter.v1.ResumeRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	12, // 31: lenny.adapter.v1.ResumeRequest.experiment_context:type_name -> lenny.adapter.v1.ExperimentContext
	63, // 32: lenny.adapter.v1.ResumeRequest.tracing_context:type_name -> lenny.adapter.v1.ResumeRequest.TracingContextEntry
	6,  // 33: lenny.adapter.v1.ExportPathsRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	41, // 34: lenny.adapter.v1.ExportPathsRequest.exports:type_name -> lenny.adapter.v1.ExportSpec
	43, // 35: lenny.adapter.v1.ExportPathsResponse.files:type_name -> lenny.adapter.v1.ExportedFile
	6,  // 36: lenny.adapter.v1.ReportUsageRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	6,  // 37: lenny.adapter.v1.ExtendLeaseRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	4,  // 38: lenny.adapter.v1.ExtendLeaseResponse.status:type_name -> lenny.adapter.v1.ExtendLeaseResponse.Status
	6,  // 39: lenny.adapter.v1.ShutdownRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	6,  // 40: lenny.adapter.v1.ConfigureWorkspaceRequest.session_id:type_name -> lenny.adapter.v1.SessionId
	12, // 41: lenny.adapter.v1.ConfigureWorkspaceRequest.experiment_context:type_name -> lenny.adapter.v1.ExperimentContext
	64, // 42: lenny.adapter.v1.ConfigureWorkspaceRequest.tracing_context:type_name -> lenny.adapter.v1.ConfigureWorkspaceRequest.TracingContextEntry
	34, // 43: lenny.adapter.v1.AssignCredentialsRequest.LeasesEntry.value:type_name -> lenny.adapter.v1.CredentialLease
	34, // 44: lenny.adapter.v1.RotateCredentialsRequest.LeasesEntry.value:type_name -> lenny.adapter.v1.CredentialLease
	13, // 45: lenny.adapter.v1.Adapter.PrepareWorkspace:input_type -> lenny.adapter.v1.PrepareWorkspaceRequest
	15, // 46: lenny.adapter.v1.Adapter.FinalizeWorkspace:input_type -> lenny.adapter.v1.FinalizeWorkspaceRequest
	18, // 47: lenny.adapter.v1.Adapter.RunSetup:input_type -> lenny.adapter.v1.RunSetupRequest
	21, // 48: lenny.adapter.v1.Adapter.StartSession:input_type -> lenny.adapter.v1.StartSessionRequest
	51, // 49: lenny.adapter.v1.Adapter.ConfigureWorkspace:input_type -> lenny.adapter.v1.ConfigureWorkspaceRequest
	24, // 50: lenny.adapter.v1.Adapter.SendMessage:input_type -> lenny.adapter.v1.SendMessageRequest
	26, // 51: lenny.adapter.v1.Adapter.Attach:input_type -> lenny.adapter.v1.AttachRequest
	28, // 52: lenny.adapter.v1.Adapter.AssignCredentials:input_type -> lenny.adapter.v1.AssignCredentialsRequest
	30, // 53: lenny.adapter.v1.Adapter.RotateCredentials:input_type -> lenny.adapter.v1.RotateCredentialsRequest
	32, // 54: lenny.adapter.v1.Adapter.RevokeCredentials:input_type -> lenny.adapter.v1.RevokeCredentialsRequest
	35, // 55: lenny.adapter.v1.Adapter.Interrupt:input_type -> lenny.adapter.v1.InterruptRequest
	37, // 56: lenny.adapter.v1.Adapter.Checkpoint:input_type -> lenny.adapter.v1.CheckpointRequest
	39, // 57: lenny.adapter.v1.Adapter.Resume:input_type -> lenny.adapter.v1.ResumeRequest
	42, // 58: lenny.adapter.v1.Adapter.ExportPaths:input_type -> lenny.adapter.v1.ExportPathsRequest
	45, // 59: lenny.adapter.v1.Adapter.ReportUsage:input_type -> lenny.adapter.v1.ReportUsageRequest
	49, // 60: lenny.adapter.v1.Adapter.Shutdown:input_type -> lenny.adapter.v1.ShutdownRequest
	53, // 61: lenny.adapter.v1.Adapter.DemoteSDK:input_type -> lenny.adapter.v1.DemoteSDKRequest
	55, // 62: lenny.adapter.v1.Adapter.NegotiateVersion:input_type -> lenny.adapter.v1.NegotiateVersionRequest
	57, // 63: lenny.adapter.v1.Adapter.LifecycleChannel:input_type -> lenny.adapter.v1.LifecycleChannelRequest
	47, // 64: lenny.adapter.v1.GatewayControl.ExtendLease:input_type -> lenny.adapter.v1.ExtendLeaseRequest
	14, // 65: lenny.adapter.v1.Adapter.PrepareWorkspace:output_type -> lenny.adapter.v1.PrepareWorkspaceResponse
	16, // 66: lenny.adapter.v1.Adapter.FinalizeWorkspace:output_type -> lenny.adapter.v1.FinalizeWorkspaceResponse
	19, // 67: lenny.adapter.v1.Adapter.RunSetup:output_type -> lenny.adapter.v1.RunSetupResponse
	23, // 68: lenny.adapter.v1.Adapter.StartSession:output_type -> lenny.adapter.v1.StartSessionResponse
	52, // 69: lenny.adapter.v1.Adapter.ConfigureWorkspace:output_type -> lenny.adapter.v1.ConfigureWorkspaceResponse
	25, // 70: lenny.adapter.v1.Adapter.SendMessage:output_type -> lenny.adapter.v1.SendMessageResponse
	27, // 71: lenny.adapter.v1.Adapter.Attach:output_type -> lenny.adapter.v1.AttachResponse
	29, // 72: lenny.adapter.v1.Adapter.AssignCredentials:output_type -> lenny.adapter.v1.AssignCredentialsResponse
	31, // 73: lenny.adapter.v1.Adapter.RotateCredentials:output_type -> lenny.adapter.v1.RotateCredentialsResponse
	33, // 74: lenny.adapter.v1.Adapter.RevokeCredentials:output_type -> lenny.adapter.v1.RevokeCredentialsResponse
	36, // 75: lenny.adapter.v1.Adapter.Interrupt:output_type -> lenny.adapter.v1.InterruptResponse
	38, // 76: lenny.adapter.v1.Adapter.Checkpoint:output_type -> lenny.adapter.v1.CheckpointResponse
	40, // 77: lenny.adapter.v1.Adapter.Resume:output_type -> lenny.adapter.v1.ResumeResponse
	44, // 78: lenny.adapter.v1.Adapter.ExportPaths:output_type -> lenny.adapter.v1.ExportPathsResponse
	46, // 79: lenny.adapter.v1.Adapter.ReportUsage:output_type -> lenny.adapter.v1.ReportUsageResponse
	50, // 80: lenny.adapter.v1.Adapter.Shutdown:output_type -> lenny.adapter.v1.ShutdownResponse
	54, // 81: lenny.adapter.v1.Adapter.DemoteSDK:output_type -> lenny.adapter.v1.DemoteSDKResponse
	56, // 82: lenny.adapter.v1.Adapter.NegotiateVersion:output_type -> lenny.adapter.v1.NegotiateVersionResponse
	58, // 83: lenny.adapter.v1.Adapter.LifecycleChannel:output_type -> lenny.adapter.v1.LifecycleChannelResponse
	48, // 84: lenny.adapter.v1.GatewayControl.ExtendLease:output_type -> lenny.adapter.v1.ExtendLeaseResponse
