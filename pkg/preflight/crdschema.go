...
// CRDSchemaVersionCheck runs the §10 preflight comparison:
...
// §10 verbatim text operator runbooks grep for; the PostUpgrade
...
func (c CRDSchemaVersionCheck) message(name, got, expected, kind string) string {
	...
	default:
		// spec: §10 message verbatim — operator runbooks grep for it.
