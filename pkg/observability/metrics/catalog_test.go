...
var spec161Metrics = []string{
	...
	"lenny_orphan_tasks_active_per_tenant", "lenny_memory_store_operation_duration_seconds",
	...
	"lenny_time_drift_seconds", "lenny_postgres_replication_lag_seconds", "lenny_restore_test_success",
