...
// spec: §4.8 — an unwired or empty PreRoute chain admits the
// request unchanged.
...
// spec: §4.8 — a deliberate REJECT on the PostRoute chain
...
// spec: §4.8, §15.1 — a fail-closed timeout/error on
...
// spec: §4.8 — a PreRoute MODIFY may rewrite the runtime hint
...
// spec: §4.8, §15.1 — a PreRoute MODIFY
...
// spec: §4.8, §15.1 — a PostRoute MODIFY
...
// spec: §4.8, §15.1 — a deliberate REJECT that carries a
...
// spec: §4.8 — runRouteChainRange splits the PreRoute chain
...
// spec: §4.8 — the at-or-above segment of the PreRoute chain
