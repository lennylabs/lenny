...
// concurrency_style is absent: migration 0167 retired the column with
// the §5.2 concurrent sub-variant, leaving max_concurrent as the
// surviving per-pod bound. spec: §5.2 (execution modes), §12.6.
