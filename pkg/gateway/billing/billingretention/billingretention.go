...
const (
	...
	// and dispute resolution. spec: §11.2.1.
...
// profile has no floor. spec: §11.2.1.
...
// bypass a floor. spec: §11.2.1. F-11.2.15.
...
// partial count so the sweep is best-effort. spec: §11.2.1.
