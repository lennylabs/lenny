...
// The payload carries no slot address: the event's session identifier
// names the session, and a session-mode slot's identifier is its
// session's identifier.
// spec: §15.2; §5.2 (identity invariant).
