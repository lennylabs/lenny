...
//
// spec: §15.2 "Version negotiation" and §15.5 item 2.
...
const (
	// CurrentProtocolVersion is the §15.2 target MCP spec
	...
	// still serves during its §15.2 / §15.5 item 2 six-month
	...
	// supported version. spec: §15.2.
	ProtocolVersion = CurrentProtocolVersion

	// headerMCPVersionDeprecated is the §15.2 warning header the
...
// supportedVersions is the §15.2 concurrently-served set,
...
// negotiateVersion applies the §15.2 negotiation rules to
...
// negotiation is identical on every MCP transport. spec: §15.2.
