...
// spec: §4.8, §8.3 — DelegationPolicyEvaluator
...
// spec: §8.3 — when a resolver supplies a tighter effective
...
// spec: §8.3 — a resolver miss (ok == false) falls back to the
...
// spec: §8.3 — a non-positive configured default selects the
// §8.3 128 KiB default.
...
// spec: §4.8 — the built-in registers at the reserved priority
