...
// 400 ENV_VAR_BLOCKLISTED. spec: §14. F-14.1.12.
package envblock
...
// cannot be reduced, so it is always merged in first. spec: §14.
...
// default blocklist alone. spec: §14. F-14.1.12.
...
// comparison. spec: §14 — "full-string wildcard ... case-sensitive".
