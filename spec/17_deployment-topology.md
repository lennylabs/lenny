...
**Helm chart** is the primary installation mechanism. The chart packages all Lenny components: gateway, token service, warm pool controller, CRD definitions, RBAC, NetworkPolicies, admission policies (OPA/Gatekeeper or Kyverno manifests per [Section 17.2](#172-namespace-layout)), and cert-manager resources.
