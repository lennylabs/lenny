...
//  3. dualStoreDown — both Postgres and Redis are unreachable. The
...
//  4. hard-dependency unhealthy — the externalized session-truth store
...
//
// spec: §10.4 line 386; §10.1 dual-store unavailability; §13.3 line 595;
// §12.4 advisory-lock lease fallback. F-10.4.6.
func readinessVerdict(ctx context.Context, draining, clockDrift, dualStoreDown bool, probe hardDepProbe) readinessResult {
	if draining {
