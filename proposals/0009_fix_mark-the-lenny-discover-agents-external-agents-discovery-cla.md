...
- **Status:** Approved (2026-06-19). Converged after 2 adversarial review rounds (0 findings fixed); signed off by the human approver. Open decision (marker register) resolved in favor of the staged softer "for future A2A support" clause, for intra-section consistency with §8 line 307. Awaiting `implement-proposal` to land the line-244 spec edit and close F-8.5.20.
- **Date:** 2026-06-19.
