...
- **Status:** Applied to spec (2026-06-19; spec-apply commit `6670a310`). Verified and converged after 3 adversarial review rounds (2 findings fixed); signed off by the human approver. Findings closed: F-11.4.5 (flipped DEFERRED → CLOSED) and F-11.4.9 (resolution updated to record the reconciling spec edit as landed) in `BUILD-GAPS.md`. Spec-only; no code, schema, or chart change.
- **Date:** 2026-06-19.
