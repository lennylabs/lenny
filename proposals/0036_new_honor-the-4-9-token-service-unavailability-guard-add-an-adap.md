...
- **Status:** Approved (2026-07-16, signed off by jaf@dubium.io). Converged after 6 adversarial review rounds (6 findings fixed). Ready for implement-proposal; not yet implemented. Land as a coordinated pair with proposal 0037 (both touch `credrenewal` / `cmd/lenny-gateway/revocation.go`).
- **Date:** 2026-07-14.
