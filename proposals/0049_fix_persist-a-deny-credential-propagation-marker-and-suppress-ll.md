...
- **Status:** Applied to spec (2026-07-18). Converged after 2 adversarial review rounds (0 findings fixed). Both §9 open decisions resolved at sign-off: persist the boolean `CredentialDeny` marker (not a full enum column); keep the SPEC-1 §8.3 origin-chain clarification.
- **Date:** 2026-07-18.
