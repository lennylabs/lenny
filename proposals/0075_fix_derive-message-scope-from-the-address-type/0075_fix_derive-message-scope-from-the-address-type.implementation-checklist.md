...
- [x] **S1 · spec** — SPEC-1. The derivation rule, its stream-envelope clause, and the constraint the
...
- [x] **S2 · test** — TEST-1. The tier-0 table-reconciliation gate is replaced by the rule gate over the
...
- [x] **S3 · test** — TEST-2. The tier-3 session-address suite separates the set of messages the
