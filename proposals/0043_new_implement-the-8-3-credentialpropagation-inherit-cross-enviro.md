...
- `tests/tier4_integration/cross_environment_delegation_test.go`: TEST-1 (un-skip and implement the admit — including the assigned-provider assertion — the reject, and the multi-hop cases, `:41-62`).
