...
- **Status:** Approved (2026-07-18, signed off by jaf@dubium.io). Converged after 2 adversarial review rounds; both §9 open decisions ratified by the reviewer (option (b) `minAvailable = minWarm-1`; no PDB below `minWarm` 2). Ready for implement-proposal; not yet implemented.
- **Date:** 2026-07-18.
