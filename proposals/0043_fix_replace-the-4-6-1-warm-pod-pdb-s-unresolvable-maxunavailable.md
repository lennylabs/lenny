...
- **Status:** Applied to spec (2026-07-18). Converged after 2 adversarial review rounds; both §9 open decisions ratified by the reviewer (option (b) `minAvailable = minWarm-1`; no PDB below `minWarm` 2).
- **Date:** 2026-07-18.
