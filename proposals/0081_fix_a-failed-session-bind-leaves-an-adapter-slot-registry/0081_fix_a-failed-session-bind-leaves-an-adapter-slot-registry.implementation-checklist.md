...
- [ ] **S16 · code** — CODE-1 and CODE-15 in full, CODE-9's untokened-entry series, and the `Shutdown` rows of CODE-14's derivation table and removing-site table, with the tests the landing table assigns to S16, CODE-1's `ShutdownRequest` literal sweep among them.
