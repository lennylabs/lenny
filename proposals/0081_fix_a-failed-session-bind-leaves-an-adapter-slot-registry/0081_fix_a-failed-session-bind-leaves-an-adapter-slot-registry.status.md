...
On 2026-09-22, an adversarial review run executed the non-spec loop. The spec loop was not run. The non-spec loop ran 14 rounds and did not converge, performing 5 full-pool sweeps. Three findings were fixed. Findings the non-spec loop had not closed remain open.
