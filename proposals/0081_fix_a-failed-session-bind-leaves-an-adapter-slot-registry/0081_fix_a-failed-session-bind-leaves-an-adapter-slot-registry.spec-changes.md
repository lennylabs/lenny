...
epoch fence depends on it. An epoch is minted for a registry entry inside one adapter process and is observed on
the responses one connection received; a compensation that dialled a fresh
