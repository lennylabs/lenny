...
- **§10.1's per-RPC coordination-generation fence is not enforced by the shipped adapter.**
  ...
  reclaim the adapter did not answer. SPEC-2's §7.1 paragraph counts it as a reclaim that did
  not complete, and SPEC-3's §5.2 disposition table states what becomes of the slot on a pod of
