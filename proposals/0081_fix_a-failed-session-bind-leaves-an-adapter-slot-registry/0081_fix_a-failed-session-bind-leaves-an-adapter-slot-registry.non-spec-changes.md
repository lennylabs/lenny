...
| Attempt 2 against a live started session | refused on the identity gate, which the cascade evaluates ahead of the phase gate; no workspace, credential, setup or staging damage and no compensation sent |
