...
- **Status:** Applied to spec (2026-06-19). Verified and converged after 4 adversarial review rounds (1 finding fixed). Open decision (marker register for the reworded line 110) resolved in favor of applying §3.1 as staged, keeping the intra-section back-reference to the Elicitation Timeout Semantics block.
- **Date:** 2026-06-19.
