...
- **Status:** Implemented (2026-06-19). Spec applied (commit 436dbd75), code landed green and review-clean (C3 a76c7284, C4 464abfdd), F-9.2.20 closed (C5 53c90f92, 5e93b1a4). Verified and converged after 4 adversarial review rounds (1 finding fixed). Open decision (marker register for the reworded line 110) resolved in favor of applying §3.1 as staged, keeping the intra-section back-reference to the Elicitation Timeout Semantics block.
- **Date:** 2026-06-19.
