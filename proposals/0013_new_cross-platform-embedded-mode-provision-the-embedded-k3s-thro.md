...
- **Status:** Approved (2026-06-19); signed off by the project owner for implementation. Verified (2026-06-19); converged after 4 adversarial review rounds (3 findings fixed). Open decision (§8): the Docker-backed launcher rolls its own `docker run rancher/k3s` to keep the prerequisite at exactly Docker, per the proposal's recommendation.
- **Date:** 2026-06-19.
