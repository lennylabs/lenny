...
- **Status:** Applied to spec (2026-07-25). Human sign-off with the settled design: chain-walk single-turn transcript storage, `truncation` ignored (runtime owns context), no replay cap (full-history replay), translator-local continuity helper, §14.1-envelope lineage (no migration). Converged after 3 adversarial review rounds.
- **Date:** 2026-07-25.
