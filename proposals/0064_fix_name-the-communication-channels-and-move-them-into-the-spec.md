...
naming law, the three registers, and the tooling that migrates every reference to them.
...
§28.4 headings are not among them, because proposal 0067 authored those four sections and SPEC-1 wrote
