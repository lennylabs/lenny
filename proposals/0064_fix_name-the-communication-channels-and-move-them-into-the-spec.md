...
here while the §28.3 register its bijection reads already exists, created by proposal 0067, so the
bijection first holds at this sub-step's exit. The artifact-register supersession check is a tier-11 gate, and it lands here
