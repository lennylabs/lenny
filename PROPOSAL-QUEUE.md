...
- **status:** in-review:0050 (prerequisite 1 of 4 + trigger; the reviewer chose to resolve C-22 prerequisite-first as a sequence of small proposals — 0050 is slot-aware checkpointing; prereqs 2-4 + the trigger follow as separate proposals. **0050 signed off and IMPLEMENTED green on branch 2026-07-19 (tiers 0/1/3/4/7a, ready for `--no-ff`); keep C-22 assigned/open for the remaining prerequisites.** See Integrator inbox.)
- **assigned:** proposal-B
