...
- **status:** landed:0049 (implemented by proposal-A 2026-07-20; SPEC-4 §25.5 deliveries-pagination amendment applied and verified as its own commit; the reached tiers are green — build/vet, tier-0 static, tier-1/2 touched packages, tier-3 contract deliveries-cursor + SSE/CloudEvents framing, and all §25.5 tier-7a load tests; tier-4/5/8/9 suites are un-skipped and compile but need compose/Kind/chaos infra to run. Closes T-25.5.1/.5/.7/.15/.20 + T-25.3.5 (RESOLVED with shas), records T-25.5.14. T-25.5.6 (single-implementor aggregator) and T-25.12.6 (MCP-native subscription) deferred to follow-on clusters — see Integrator inbox. Ready for --no-ff integration.)
- **assigned:** proposal-A
