...
- **status:** claimed:proposal-A@2026-07-26T04:28:56Z (re-approached from scratch on the post-0060 baseline: 0060/C-52 co-located the coordination lease with the pod binding, making forward-to-coordinator correct; the prior draft's async-inbox workaround for the missing co-location+forwarding is superseded — this build wires the spec-as-written §10.1 ForwardMessage transport instead)
- **assigned:** proposal-A
