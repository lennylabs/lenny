...
- **status:** in-review:0050 (prerequisite 1 of 4 + trigger; the reviewer chose to resolve C-22 prerequisite-first as a sequence of small proposals — 0050 is slot-aware checkpointing; prereqs 2-4 + the trigger follow as separate proposals. See Integrator inbox.)
- **assigned:** proposal-B
