...
| `threadId` | string | No | Thread identifier (one implicit thread per session; multi-thread support is post-v1 — see [Spec TESTING.md §21.4](https://github.com/lennylabs/lenny/blob/main/spec/21_planned-post-v1.md)) |
