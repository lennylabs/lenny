...
- `runtime.WithFullLevel()` and `runtime.WithLifecycleHandlers(...)` open the CH-RUNTIMEOPS. `runtime.OnCheckpoint`, `runtime.OnInterrupt`, `runtime.OnCredentialsRotated`, and `runtime.OnDeadline` register the lifecycle callbacks.
