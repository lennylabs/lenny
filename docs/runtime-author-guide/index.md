...
- A shortcut response format for simple replies: `{"type": "response", "slotId": "sess_abc", "text": "hello"}`. The runtime echoes the `slotId` the adapter handed it on the frames it emits in response.
