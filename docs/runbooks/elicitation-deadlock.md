---
layout: default
title: "elicitation-deadlock"
parent: "Runbooks"
triggers:
  - alert: ElicitationDeadlockDetected
    severity: warning
components:
  - platform
symptoms:
  - "an elicitation chain stalled waiting for a non-existent resolver"
tags:
  - chaos
related: []
---
...
The `ElicitationDeadlockDetected` alert fires when the §16.5 condition documented in the alert rule holds for its `for:` window. See [Metrics Reference §Alert rules](../reference/metrics.html#alert-rules) for the exact PromQL.
