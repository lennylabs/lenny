---
layout: default
title: "parent-crash-await"
parent: "Runbooks"
triggers:
  - alert: ParentSessionCrashedAwaiting
    severity: warning
components:
  - platform
symptoms:
  - "a parent session crashed while awaiting children"
tags:
  - chaos
related: []
---
...
The `ParentSessionCrashedAwaiting` alert fires when the §16.5 condition documented in the alert rule holds for its `for:` window. See [Metrics Reference §Alert rules](../reference/metrics.html#alert-rules) for the exact PromQL.
