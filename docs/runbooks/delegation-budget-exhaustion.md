---
layout: default
title: "delegation-budget-exhaustion"
parent: "Runbooks"
triggers:
  - alert: DelegationBudgetExhausted
    severity: warning
components:
  - platform
symptoms:
  - "a delegation tree exhausted its §8.6 lease budget"
tags:
  - chaos
related: []
---
...
The `DelegationBudgetExhausted` alert fires when the §16.5 condition documented in the alert rule holds for its `for:` window. See [Metrics Reference §Alert rules](../reference/metrics.html#alert-rules) for the exact PromQL.
