---
layout: default
title: "pool-upgrade-rollback"
parent: "Runbooks"
triggers:
  - alert: PoolUpgradeRolledBack
    severity: warning
components:
  - platform
symptoms:
  - "a pool upgrade was rolled back from the expanding phase"
tags:
  - chaos
related: []
---
...
The `PoolUpgradeRolledBack` alert fires when the §16.5 condition documented in the alert rule holds for its `for:` window. See [Metrics Reference §Alert rules](../reference/metrics.html#alert-rules) for the exact PromQL.
