---
layout: default
title: "crd-upgrade-immutable"
parent: "Runbooks"
triggers:
  - alert: CRDImmutableFieldChanged
    severity: critical
components:
  - platform
symptoms:
  - "an upgrade attempted to mutate an immutable Lenny CRD field"
tags:
  - chaos
related: []
---
...
The `CRDImmutableFieldChanged` alert fires when the §16.5 condition documented in the alert rule holds for its `for:` window. See [Metrics Reference §Alert rules](../reference/metrics.html#alert-rules) for the exact PromQL.
