---
layout: default
title: "schema-migration-dirty-flag"
parent: "Runbooks"
triggers:
  - alert: SchemaMigrationDirtyFlag
    severity: critical
components:
  - platform
symptoms:
  - "the migration framework recorded a dirty migration state"
tags:
  - chaos
related: []
---
...
The `SchemaMigrationDirtyFlag` alert fires when the §16.5 condition documented in the alert rule holds for its `for:` window. See [Metrics Reference §Alert rules](../reference/metrics.html#alert-rules) for the exact PromQL.
