---
layout: default
title: "cross-zone-partition"
parent: "Runbooks"
triggers:
  - alert: CrossZoneNetworkPartition
    severity: critical
components:
  - platform
symptoms:
  - "a multi-zone deployment lost cross-zone connectivity"
tags:
  - chaos
related: []
---
...
The `CrossZoneNetworkPartition` alert fires when the §16.5 condition documented in the alert rule holds for its `for:` window. See [Metrics Reference §Alert rules](../reference/metrics.html#alert-rules) for the exact PromQL.
