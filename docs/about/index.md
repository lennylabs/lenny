...
nav_order: 8
has_children: true
description: Why Lenny exists, where it fits next to other platforms, how the project is governed, and how to contribute.
---
...
| [Implementation Status](status) | What's wired up today versus what the rest of these docs describe as the target. |
