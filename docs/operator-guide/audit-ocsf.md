...
{: .note }
> **Reviewing Lenny for security or compliance? Start at [Security Principles](security-principles) §3.** This page is the wire-format reference: OCSF v1.1.0 field mapping, hash-chain integrity, SIEM delivery configuration, and verifier guidance.
