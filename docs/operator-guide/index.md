...
8. [**Observability**](observability.html) — Prometheus metrics, bundled alerting rules, the Prometheus Operator CRs, the OpenSLO export, and Grafana dashboards. Read this before Scaling — you'll use the signals it surfaces to pick the right autoscaler targets.
...
- Wire up observability: Prometheus Operator custom resources, Grafana dashboards, the bundled alerting rules, and the OpenSLO export for SLO platforms.
